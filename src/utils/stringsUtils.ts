export const CommonStrings = {
  ...
  zipMustNumber: '*ZIP code must be a number',
  ...
  contractorRecommended: 'Contractors Recommended',
  accessReport: 'Access Full Report to View',
  estimatedCost: 'Total Estimated Repair Cost',
  accessFullReport: 'Access Full Report',
  whatIncluded: `${'What'}'${'s Included:'}`,
  useOneCredit: 'Use 1 Credit',
  tenReports: 'tenReports',
